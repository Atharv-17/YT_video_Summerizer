...
and summarizing the entire video and providing the important summary in points within 200 words.
The transcript text will be appended here : """


#getting transcript data from YT vdo
...
#to show the thumbnail image of the vdo
...
if st.button("Get Summary of Video"):
